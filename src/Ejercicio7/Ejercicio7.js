...
if(finDia != 1){	//si no es lunes buscamos el anterior
...
let semanasUF = (fechaFinUltimoLunes.getTime() - fechaInicioProximoLunes.getTime())/oneDayMilliseconds/7; // Guardamos las semanas que pasan desde el primer hasta el ultimo lunes

console.log(`S: ${semanasUF}`);

let totalHorasUF = semanasUF * horasTotalSemana; // Sacamos las horas ttales de la uf en las semanas del primer lunes al ultimo

console.log(`THUF: ${totalHorasUF}`);

/*////////////////////////////////////////////////////////
			Y calculamos las horas que faltan
////////////////////////////////////////////////////////*/
